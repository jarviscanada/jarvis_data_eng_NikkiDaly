...
public class CompareMaps {
  ...
  /**
   * Description : Compares two HashMaps to see if they are equal to each other
   * Big O Notation : O(n)
   * Justification : Iterates through every key and value to compare
   */
  ...
  /**
   * Description : Compare two HashJMaps to see if they are equal to eachother
   * Big O Notation : O(n)
